<template>
  ...
  <button
    type="button"
    class="rounded-full z-[5000] bg-gray-50 text-gray-500 text-xs font-semibold leading-6 py-0.5 pl-2 pr-2.5 flex items-center hover:bg-gray-100 transition-opacity select-none dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600 pointer-events-none focus:opacity-100 focus:pointer-events-auto absolute bottom-4 right-[calc(14px+0.625rem)]"
  >
    <svg
      viewBox="0 0 20 20"
    ...
    >
      ...
      ></path></svg
    ><span class="">Copy<span class="sr-only">, then focus editor</span></span>
  </button>
</template>
